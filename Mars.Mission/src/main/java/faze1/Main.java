...
public class Main {
    public static void main( String[] args ) throws FileNotFoundException {
        ...
        phase2Rockets = U1.getU1Counter() - phase1Rockets;
        System.out.println("Rockets used for phase 2: " + phase2Rockets + "\n");

        System.out.println("A total of " + U1.getU1Counter() + " rockets was used.");
        u1Cost = totalCost(1);
        ...
        phase2Rockets = U2.getU2Counter() - phase1Rockets;
        System.out.println("Rockets used for phase 2: " + phase2Rockets);

        System.out.println("A total of " + U2.getU2Counter() + " rockets was used." + "\n");
        u2Cost = totalCost(2);
