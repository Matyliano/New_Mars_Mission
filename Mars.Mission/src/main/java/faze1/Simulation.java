...
public class Simulation {
    ...
    private File phase1 = new File("C:\\Users\\joann\\Desktop\\JavaProjekty\\Mars.Mission\\phase-1.txt");
    private File phase2 = new File("C:\\Users\\joann\\Desktop\\JavaProjekty\\Mars.Mission\\phase-2.txt");
    ...
    public void launchSimulation(int i) {
        ...
        if (i == 1) {
            int counter1 = U1.getU1Counter();
            counter1++;
            U1.setU1Counter(counter1);

        } else {
            int counter1 = U2.getU2Counter();
            counter1++;
            U2.setU2Counter(counter1);
    ...
    public void landSimulation(int i) {
        if (i == 1) {
            int counter = U1.getU1Counter();
            counter++;
            U1.setU1Counter(counter);

        } else {
            int counter = U2.getU2Counter();
            counter++;
            U2.setU2Counter(counter);
        }
        hasLanded = false;
    }
}
